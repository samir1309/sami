                                ...
                                <form method="GET" action="{{URL::current()}}" class="m-0">
                                    ...
                                    <div class="row w-100 m-0">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input class="form-control date" id="datepicker1" type="text"  name="start" placeholder="از تاریخ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input class="form-control date" id="datepicker2" type="text"  name="end" placeholder="تا تاریخ">
                                            </div>
                                        </div>
                ...
                <div id="myModal2" class="modal">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-3">
                                <form method="GET" action="{{URL::action('Admin\UserController@export')}}" class="m-0">
...
{{--														</th>--}}
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">{{$row->name.' '.$row->family}}</td>
...
{{--														</td>--}}
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($row->gender==0)
                                                                <span class='label label-success'>مونث</span>
                                                            @else
                                                                <span class='label label-primary'> مذکر</span>
                                                            @endif
...
{{--                                                            <button  type="button" class="btn btn-info" data-toggle="modal" data-target="#edit{{$row->id}}">نمایش--}}
{{--                                                            </button>--}}
                                                            <a href="{{URL::action('Admin\UserController@getEdit2',[$row->id])}}"
                                                               data-toggle="tooltip" data-original-title="ویرایش اطلاعات"
                                                               class="btn btn-xs  btn-warning"><i class="fa fa-edit"></i> ویرایش </a>
                                                                   <a href="{{URL::action('Admin\UserController@getAddress',[$row->id])}}"
                                                               data-toggle="tooltip" data-original-title="آدرس ها"
                                                               class="btn btn-xs  btn-info"><i class="fa fa-location-arrow"></i> آدرس ها </a>
                                                            @if($row->status == 0)

                                                                <a href="{{route('admin.user.status',['id'=>$row->id])}}" data-toggle="tooltip"
                                                                   class="btn btn-success  btn-xs">فعال کردن کاربر</a>
                                                            @else
                                                                <a href="{{route('admin.user.status',['id'=>$row->id])}}" data-toggle="tooltip"
                                                                   class="btn btn-danger  btn-xs" ></i>غیرفعال کردن کابر</a>
                                                            @endif
                ...
                <div class="modal-body p-3">
                    <div class="row w-100 m-0">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">نام:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="name" name="name" value="{{$row->name}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">نام خانوادگی:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="family" name="family" value="{{$row->family}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">ایمیل:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" id="email" name="email" value="{{$row->email}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">تلفن:</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" id="mobile" name="mobile" value="{{$row->mobile}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">جنسیت :</label>
                            <div class="col-lg-9">
                                <select name="gender" id="gender" class="form-control" disabled>
                                    @foreach($gender as $key=>$item)
                                        <option value="{{$key}}" @if(isset($row->gender) and $row->gender==$key)
                                        selected
                                            @endif>{{$item}}</option>
                                    @endforeach
                                </select>
