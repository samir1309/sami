...
Route::get('/user-login-as/{id}','Panel\PanelController@getUserLogin');
$seg = request()->segments();

$redirect = Redirects::where('old_address',str_replace('https://www.kajshop.com/','',str_replace('http://www.kajshop.com/','',url()->current())))->first();
