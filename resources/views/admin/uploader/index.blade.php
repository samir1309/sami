	...
	<div class="card">
			...
			<div class="">
				...
				<div class="px-2 py-3">
					...
					<a href="{{URL::action('Admin\ContentController@getAddUploader')}}" type="button" class="btn btn-space btn-primary">
														...
														<tr role="row" class="odd">
															...
															<td class="sorting_1">
                                                                <img class="m-auto"
                                                                   ...
                                                                   src="{{asset('assets/uploads/content/upl/small/'.$upl->image)}}"
                                                                     alt="Image"  width="70" height="70">
                                                            </td>

															<td class="sorting_1">  {{$upl->title}} </td>
<td class="sorting_1" style="direction: ltr;font-family: arial;">    {{asset('assets/uploads/content/upl/big/'.$upl->image)}} </td>
<td>
