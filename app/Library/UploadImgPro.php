    ...
    public function uploadPic($file, $path, $resize = true)
    {
        ...
        if (in_array($extension, $ext)) {
            ...
            if ($resize) {
                ...
                ResizerPro::resizePic($pathMain . $fileName, $pathSmall . $fileName, 150, 150, $fileExt);
                ResizerPro::resizePic($pathMain . $fileName, $pathMedium . $fileName, 300, 300, $fileExt);
                ResizerPro::resizePic($pathMain . $fileName, $pathBig . $fileName, 1000, 1000, $fileExt, True);
