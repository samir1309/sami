    ...
    public function uploadPic($file, $path, $resize = true)
    {
        ...
        if (in_array($extension, $ext)) {
            ...
            if ($resize) {
                ...
                ResizerArt::resizePic($pathMain . $fileName, $pathSmall . $fileName, 70, 50, $fileExt);
                ResizerArt::resizePic($pathMain . $fileName, $pathMedium . $fileName, 300, 200, $fileExt);
                ResizerArt::resizePic($pathMain . $fileName, $pathBig . $fileName, 600, 400, $fileExt, True);
