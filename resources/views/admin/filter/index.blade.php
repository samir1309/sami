...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row w-100 m-0">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
            @if($parent)
                <a href="{{URL::action('Admin\FilterController@getList',$parent->parent_id)}}" class="btn btn-default btn-info" style="float: left" data-toggle="tooltip" data-placement="top" title="" data-original-title="بازگشت">
                    بازگشت
	...
	<div class="card">
			...
			<div class="py-3 px-2">
                ...
                <a href="{{URL::action('Admin\FilterController@getAdd',$parent_id)}}"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('Admin\FilterController@getEdit',$row['id'])}}"
																type="button"
																class="btn btn-space btn-warning"
																data-toggle="tooltip" title="ویرایش">
																<i class="fa fa-edit"> </i>
															</a>
                                                            <a href="{{URL::action('Admin\FilterController@getDelete',$row['id'])}}"
                                                               type="button"
															...
															<a href="{{URL::action('Admin\FilterController@getList',$row['id'])}}"
																type="button"
