    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="card">
            ...
            <div class="py-3 px-2">
                ...
                {{--					حذف انتخاب شده ها--}}
                {{--				</button>--}}
                <a href="{{url('admin/quizes/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                ...
                                                <table class="table table-striped table-bordered first dataTable"
                                                    ...
                                                    @foreach($data as $key=> $quiz)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a href="{{URL::action('Admin\QuizController@getEdit',$quiz->id)}}"
                                                                   type="button"
                                                                   class="btn btn-space btn-warning"
                                                                   data-toggle="tooltip" title="ویرایش">
                                                                    <i class="fa fa-edit"> </i>
                                                                </a>
                                                                <a href="{{URL::action('Admin\QuizController@question',$quiz->id)}}"
                                                                   type="button"
                                                                   class="btn btn-space btn-success"
                                                                   data-toggle="tooltip" title="سوالات">
                                                                    <i class="fa fa-question"> </i>
                                                                </a>
                                                                <a href="{{URL::action('Admin\QuizController@getDelete',$quiz->id)}}"
                                                                   type="button"
            ...
            @else
                <p class="p-5 text-center ismb">شما کوئیزی ثبت نکردید</p>
