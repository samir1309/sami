    ...
    public function uploadPic($file, $path, $resize = true)
    {
        ...
        if (in_array($extension, $ext)) {
            ...
            if ($resize) {
                ...
                ResizerBrand::resizePic($pathMain . $fileName, $pathSmall . $fileName, 90, 90, $fileExt);
                ResizerBrand::resizePic($pathMain . $fileName, $pathMedium . $fileName, 200, 200, $fileExt);
                ResizerBrand::resizePic($pathMain . $fileName, $pathBig . $fileName, 400, 400, $fileExt, True);
