...
<div class="row">
    ...
    <div class="col-lg-6 form-group">
    <label for="title" class="col-form-label">  زبان</label>
    <select class="form-select" name="lang"  id="lang"  aria-label="Default select example" value="@if(isset($data->lang)){{$data->lang}}@endif">
        <option  value="fa"  @if(isset($data->lang)) @if($data->lang=="fa" ) selected @endif @endif>فارسی</option>
        <option value="en" @if(isset($data->lang)) @if($data->lang=="en" ) selected @endif @endif>انگلیسی</option>
    </select>
    </div>
