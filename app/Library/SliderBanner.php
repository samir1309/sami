...
class SliderBanner
{
    ...
    {
        $banner_sliders = Content::orderby('sort','ASC')->Banner()->select(['id','title','url','link','image','description','content_type'])->get();
        $banners= [
            'above'=>[],
            'mid'=>[],
            'below'=>[]
    ...
    {
        $banner_mobiles = Content::orderby('sort','ASC')->Mobile()->select(['id','title','url','link','image','description','content_type'])->get();
        $mobiles= [
