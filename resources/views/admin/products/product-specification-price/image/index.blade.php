...
@section('content')
    <div class="container-fluid  dashboard-content">
        ...
        <br>
        <div class="card">
            @include('admin.products.product-specification-price.image.add')
                                                ...
                                                <table class="table table-striped table-bordered first dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                    ...
                                                    @foreach($data as $key=> $row)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1 text-center">
                                                                @if($row->thumbnail == 0)
                                                                    <a class="btn btn-warning m-0 rounded-0 me-2" href="{{URL::action('Admin\ProductController@editThumbnail',$row->id)}}" onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();">انتخاب به عنوان مشخصه</a>
                                                               @endif
                                                                @if($row->thumbnail == 1)
                                                                    <span class='label label-success'> تصویر مشخصه</span>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @endforeach
