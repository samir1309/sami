...
@section('content')
<div class="container-fluid dashboard-content" id="blogCat68">
	<div class="row w-100 m-0">
		<div class="col-lg-12 mx-auto py-1 px-0">
			...
			<div class="card rounded-lg border-0 p-3">
                <form method="post" action="{{URL::action('Admin\ArticleController@postEditArticleCat',$data->id)}}"
                    enctype="multipart/form-data">
                    @include('admin.article-cat.form')
                </form>
			</div>
		</div>
	</div>
