                        ...
                        <div id="list">
                            ...
                            <ul>
                                ...
                                <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                                    ...
                                    <span style="font-size: 10px;">	ترتیب مشخصات  </span>
                                </div>
                                <span style="font-size: 10px;">	ترتیب مشخصات  </span>
                                @foreach($sort as $fSort)
        ...
        $(function () {
            $("#list ul").sortable({
                opacity: 0.8, cursor: 'move', update: function () {
                    ...
                    $.post("{!!URL::action('Admin\ProductSpecificationTypeController@postSort')!!} ", order, function (theResponse) {
