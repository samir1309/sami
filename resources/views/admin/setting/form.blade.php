...
<div class="row">
    ...
    <div class="col-lg-6 form-group">
      ...
      <div class="col-lg-6 form-group">
        <label class="col-form-label"> بک گراند قسمت فروش ویژه موبایل </label>
        <input class="form-control" type="file" name="sale_background_mobile">
        @if(isset($data->sale_background_mobile))
            <img src="{{asset('assets/uploads/content/set/'.$data->sale_background_mobile)}}" class="w-50">
        @endif
    </div>
	<div class="col-lg-6 form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label for="contactus" class="col-form-label">متن تماس با ما </label>
        <a href="{{url('/contact-us')}}" target="_blank" type="button" data-toggle="tooltip" title="مشاهده در سایت"
           class="btn btn-outline-primary btn-circle"><i class="fa fa-eye"></i></a>
        <textarea class="form-control ckeditor" id="contactus" name="contactus" rows="3">@if(isset($data->contactus)){!!$data->contactus !!}@endif</textarea>
    </div>
    <div class="col-lg-6 form-group">
        <label for="alert_contact" class="col-form-label">متن آلرت تماس با ما</label>
        <textarea class="form-control" id="alert_contact" name="alert_contact" rows="3">@if(isset($data->alert_contact)){!!$data->alert_contact !!}@endif</textarea>
    </div>
    <div class="form-group">
