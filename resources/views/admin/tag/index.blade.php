...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
        <div class="px-2 py-3">
            <a href="{{url('admin/tags/add')}}" type="button" class="btn btn-space btn-primary">
		...
		<form method="post" action="{{url('/admin/tags/delete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">
                                                            {{@$row['index'] == 1 ? 'index' : 'noindex'}}
                                                        </td>

														<td>
															<a href="{{URL::action('Admin\TagController@getEdit',$row->id)}}"
																type="button"
