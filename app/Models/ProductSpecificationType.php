...
class ProductSpecificationType extends Model
{
    ...
    protected $fillable = ['title', 'name', 'parent_id','old_id1','old_id2','status','filter','sort'];
   ...
   public function spec()
    {
        return $this->hasMany('App\Models\ProductSpecification', 'product_specification_type_id','id');
    }
