    ...
    public function uploadPic($file, $path, $resize = true)
    {
        ...
        if (in_array($extension, $ext)) {
            ...
            if ($resize) {
                ...
                ResizerSlider::resizePic($pathMain . $fileName, $pathSmall . $fileName, 200, 200, $fileExt);
                ResizerSlider::resizePic($pathMain . $fileName, $pathMedium . $fileName, 400, 400, $fileExt);
                ResizerSlider::resizePic($pathMain . $fileName, $pathBig . $fileName, 350, 400, $fileExt, True);
