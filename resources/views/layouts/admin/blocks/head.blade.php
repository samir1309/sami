<head>
	...
	<title>
		...
		<link rel="stylesheet" href="{{asset('assets/admin/libs/css/style.css?v1')}}">
		<link rel="stylesheet" href="{{asset('assets/admin/css/tyle.css?v5')}}">
	...
	<link rel="stylesheet" href="{{asset('assets/admin/vendor/fonts/circular-std/style.css?v10')}}">
