    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <table
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="Name: activate to sort column descending">
                                                    @if($pay)
                                                        {{jdate(' H:i Y/m/d ',@$pay->created_at->timestamp)}}
                                                    @else
                                                        {{jdate(' H:i Y/m/d ',@$order->created_at->timestamp)}}
                                                    @endif
                                                </th>
                                            </tr>
                ...
                @if($history->count() > 0)
                    <div class="col-xl-12 ">
                        <div class="card">
                            <h5 class="card-header" style="color: #3c8dbc;"><i class="fa fa-file"
                                                                               aria-hidden="true"></i>
                                &nbsp;&nbsp;
                                مراحل انجام شده</h5>
                                                ...
                                                <table
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting_asc" tabindex="0"
                                                            ...
                                                            style="width: 80.0667px;"
                                                            aria-sort="ascending"
                                                            aria-label="Name: activate to sort column descending">زمان
                                                            ثبت
                                                        </th>
                                                    </tr>
                                        ...
                                        <table
                                            ...
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    style="width: 80.0667px;"
                                                    aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending">مبلغ محاسبه
                                                    شده
                                                </th>
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="DataTables_Table_0"
                                            ...
                                            <th class="sorting_asc" tabindex="0"
                                                ...
                                                style="width: 80.0667px;"
                                                aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending">کد رهگیری پست
                                            </th>
                                            <th class="sorting_asc" tabindex="0"
                                                aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                                style="width: 80.0667px;"
                                                aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending">{{@$order->post_tracking}}</th>
                                            </tr>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="DataTables_Table_0"
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending">
                                                    <span class="badge" style="@if($order->orderStatus->id == 1) background-color:#6610f2 @endif @if($order->orderStatus->id == 3) background-color:#198754 @endif
                                                    @if($order->orderStatus->id == 4) background-color:#ffc107 @endif @if($order->orderStatus->id == 5) background-color:#6c757d @endif
                                                    @if($order->orderStatus->id == 6) background-color:#0d6efd @endif @if($order->orderStatus->id == 10) background-color:#dc3545 @endif
                                                    @if($order->orderStatus->id == 9) background-color:#0e0e0e @endif @if($order->orderStatus->id == 2) background-color:#0dcaf0 @endif
                                                        ">
                                            ...
                                            <tr role="row">
                                                <form
                                                    ...
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        @php
                                                            $h = \App\Models\OrderHistory::where('order_id',$order->id)->where('order_status_id',$order->order_status_id)->first();
                                                            @endphp
                                                        <label for="order_description"
                                                               class="col-form-label">توضیحات ادمین </label>
                                                        <textarea class="form-control" id="order_description"
                                                                  name="order_description" rows="3"
                                                               >{!!@$h->order_description !!}</textarea>
                                                        </br>
        ...
        @if($order->gift == 1)
            ...
            <span class="text-danger">
                                                درخواست ارسال به صورت کادو شده
                                            </span>
            </div>
        @endif
                                ...
                                <div class="row w-100 m-0">
                                        ...
                                        <table
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0"
                                                    ...
                                                    style="width: 155.217px;"
                                                    aria-label="Age: activate to sort column ascending">
                                                  تخفیف اعمال شده/مبلغ بعد از تخفیف
                                                </th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                    ...
                                    ->withTrashed()->orderby('id','desc')->where('black_friday','1')->first();
                                                            ...
                                                            <td class="sorting_1">
                                                                ...
                                                                @if($item->old_price != 0)
                                                                    ({{number_format($item->old_price)}}تومان)
                                                                @endif
                                                            </td>
                                                        @else
                                                            <td class="sorting_1">
                                            ...
                                            ->withTrashed()->orderby('id','desc')->where('black_friday','1')->first();
                                                                    ...
                                                                    @endphp
                                                                    {{number_format(intval(@$item->old_price - @$blackfriday_price->price ))}}
                                                                @else
                                                                    {{number_format(intval(@$item->old_price - @$item->price ))}}
                                                                @endif
                                                            @else
                                                                0
                                                            @endif
                                                        ...
                                                        <td class="sorting_1">
                                                            @if($item->discount)
                                                                {{number_format(intval(@$item->price - @$item->discount))}} / {{number_format(@$item->discount)}}
                                                        ...
                                                        <td class="sorting_1">
                                                            @if($item->discount)
                                                            {{number_format(@$item->quantity * @$item->discount)}} تومان
                                                            @else
                                                                {{number_format(@$item->quantity * @$item->price)}} تومان
                                                            @endif
                                                        </td>
                                                        <td class="sorting_1">
                                                            @if($item->order_item_status_id == 5)<span
                                                                class='label label-danger'>مرجوع شد@else<span
                                                                    class='label label-warning'>--</span>@endif
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                ...
                                <table
                                    ...
                                    @foreach($orders as $key=> $row)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1">
                                                                <span class="badge"
                                                                      style="@if($row->orderStatus->id == 1) background-color:#6610f2 @endif @if($row->orderStatus->id == 3) background-color:#198754 @endif
