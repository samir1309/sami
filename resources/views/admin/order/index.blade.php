													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td class="sorting_1">{{number_format(@$row->payment)}} </td>
																<td class="sorting_1">
                                                                @if(@$row->post_type == 1) پیشتاز @endif
                                                                @if(@$row->post_type == 4) پیک @endif
                                                                @if(@$row->post_type == 2) تیپاکس @endif
                                                                @if(@$row->post_type == 3) هوایی @endif
                                                            </td>
                                                            <td class="sorting_1">
                                                                {{@$row->address->transferee_name . ' ' . @$row->address->transferee_family}}
                                                            </td>
															<td class="sorting_1">
															...
															<td>
																<a href="{{URL::action('Admin\OrderController@getDetail',$row['id'])}}"
																   ...
																   <a href="{{URL::action('Admin\TicketController@ticketCreate',$row['id'])}}"
                                                                   type="button"
