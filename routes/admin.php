...
//Admin Routes
// Route::get('/webp', 'Site\WebpController@convertProWebp');
// Route::get('/sliderwebp2', 'Site\WebpController@convertSliderWebp2');
// Route::get('/catartwebp', 'Site\WebpController@convertCatArtWebp');
// Route::get('/artwebp', 'Site\WebpController@convertArtWebp');
// Route::get('/catwebp', 'Site\WebpController@convertCatWebp');
// Route::get('/contentcat', 'Site\WebpController@convertContent');
// Route::get('/brandwebp', 'Site\WebpController@convertBrandWebp');


Route::get('/category-webp', 'Site\LastController@categoryWebp');

Route::get('/replace-brands', 'Site\LastController@replaceBrands');
Route::post('/restore', 'Admin\CommentController@restore');

Route::post('/ckeditor/upload', [CkeditorController::class, 'upload'])->name('ckeditor.upload');

Route::get('/get-go', 'Site\LastController@getBackGo');
Route::get('/testorder', 'Admin\OrderController@test');
Route::get('admin/question-answer/delete/{id}', 'Admin\QuizController@removeOldAnswer')->name('admin.answer.remove');

Route::get('/convert-webp-articles', 'Site\LastController@convertWebpArticles');

Route::get('/convert-webp-others', 'Site\LastController@convertWebpOthers');

Route::get('/resize-pics', 'Site\LastController@reziseOldPics');
Route::get('/hamidepiss', 'Site\LastController@convetWebps2');
Route::get('/spf-convert', 'Site\LastController@spfConvert');

Route::get('/replace-names', 'Site\LastController@replaceNames');
Route::get('admin2/brands/export', 'Admin\BrandController@export');

Route::get('/jpg', 'Site\WebpController@jpg');
Route::get('/jpg-cat', 'Site\WebpController@jpgCat');
Route::get('/jpg-last', 'Site\LastController@convertPro');
...
Route::get('/fixingstock2', 'Admin\SettingController@fixingStock');
Route::post('/order/track/{id?}', 'Admin\OrderController@postTrack');
Route::get('/fixinginv', 'Admin\SettingController@fixingInv');
Route::get('/imgs', 'Site\WebpController@convertProWebp');
Route::get('/copyimages', 'Site\WebpController@copy');
// Route::get('/intprice', 'Site\WebpController@price');
// Route::get('/intoldprice', 'Site\WebpController@price2');
// Route::get('/order_count', 'Site\WebpController@countOrder');
// Route::get('/like_count', 'Site\WebpController@countLike');

Route::post('/admin/user/pass-edit/{id}', 'Admin\UserController@postPassEdit');

Route::namespace('Admin')->prefix('admin')->group(function () {

    Route::get('/order/export-mine', 'OrderController@exportMine');
    Route::get('/order/export-mine', 'OrderController@exportMine');

    Route::post('/setspcs', 'ProductFilterController@setSpc')->name('admin.set-spc');
    ...
    Route::post('product-specification-type/sort', 'ProductSpecificationTypeController@postSort');
    Route::get('product-specification-type/first-sort', 'ProductSpecificationTypeController@getFirstSort');
    //Box
    ...
    Route::get('category/first-sort', 'CategoryController@getFirstSort');
    Route::post('category/first-sort-add', 'CategoryController@postFirstSort');
    //sort-quiz
    Route::post('/quizes/questions-sort', 'QuizController@postSortQuestion');
    Route::post('quizes/answers-sort', 'QuizController@postSortAnswer');
   //commenent-status
    Route::get('comment/status/{id}', 'CommentController@getStatus');
   ...
   //group product
        ...
        Route::get('/tickets/create/{id?}', 'TicketController@ticketCreate')->name('admin.ticket.create');
        Route::post('/tickets/add', 'TicketController@addTicket')->name('admin.ticket.add');
        ...
        Route::get('tags/add', 'TagController@getAdd');
        Route::post('tags/add/', 'TagController@postAdd');
        ...
        //QuizTags
        Route::get('quiz-tags', 'QuizController@getTag');
        Route::get('quiz-tags/add', 'QuizController@getAddTag');
        Route::post('quiz-tags/add/', 'QuizController@postAddTag');
        Route::get('quiz-tags/edit/{id}', 'QuizController@getEditTag');
        Route::post('quiz-tags/edit/{id}', 'QuizController@postEditTag');
        Route::post('quiz-tags/delete/', 'QuizController@postDeleteTag');
        //Quiz
        Route::get('quizes', 'QuizController@get');
        Route::get('quizes/add', 'QuizController@getAdd');
        Route::post('quizes/add/', 'QuizController@postAdd');
        Route::get('quizes/edit/{id}', 'QuizController@getEdit');
        Route::post('quizes/edit/{id}', 'QuizController@postEdit');
        Route::post('quizes/delete/', 'QuizController@postDelete');
        Route::get('quizes/delete/{id}', 'QuizController@getDelete');
        //QuizProduct
        Route::get('quizes/product/{id}', 'QuizController@product');
        Route::post('quizes/product/', 'QuizController@postProduct');
        //QuizQuestion
        Route::get('quizes/questions/{id}', 'QuizController@question');
        Route::post('quizes/questions/', 'QuizController@postQuestion');
        Route::get('quizes/questions-edit/{id}', 'QuizController@questionEdit');
        Route::post('quizes/questions-edit/{id}', 'QuizController@postQuestionEdit');
        Route::get('quizes/questions-delete/{id}', 'QuizController@questionDelete');
        ...
        Route::get('/specification-type/category/{id}', 'SpecificationTypeController@getListCategory')->name('admin.specification-type.post-add-category2');
        ...
        Route::get('product-specification-price/imgsort/{spf_id}', 'ProductSpecificationPriceController@getImg');
        Route::get('product-specification-price/imgs-add/{spf_id}', 'ProductSpecificationPriceController@getAddImage');
        Route::post('product-specification-price/imgs-add/{spf_id}', 'ProductSpecificationPriceController@postAddImage');
        Route::get('product-specification-price/delete-image/{image_id}', 'ProductSpecificationPriceController@deleteImage');
        Route::get('product-specification-price/thumbnail-image/{image_id}', 'ProductSpecificationPriceController@thumbnailImage');
        ...
        //Filters
        Route::get('filter/list/{id?}', 'FilterController@getList');
        Route::get('filter/add/{id?}', 'FilterController@getAdd');
        Route::post('filter/add/{id?}', 'FilterController@postAdd');
        Route::post('filter/add-main/{id?}', 'FilterController@postAddMain');
        Route::get('filter/edit/{id}', 'FilterController@getEdit');
        Route::post('filter/edit/{id}', 'FilterController@postEdit');
        Route::post('filter/delete', 'FilterController@postDelete');
        Route::post('filter/cat-add', 'FilterController@postCatAdd');
        Route::get('filter/cat-delete/{id}/{c_id}', 'FilterController@getCatDelete');
        Route::get('filter/delete/{id}/', 'FilterController@getDelete');
        //Filters
        Route::get('product-filter/list/{product_id}', 'ProductFilterController@getIndex');
        Route::get('product-filter/add/{product_id}', 'ProductFilterController@getAdd');
        Route::post('product-filter/add/{product_id}', 'ProductFilterController@postAdd');
        Route::post('product-filter2/delete', 'ProductFilterController@postDelete');
        ...
        Route::post('/notification/delete/', 'BellController@postDelete');
