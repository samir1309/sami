...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'post_type', 'state_id', 'city_id','post_price','order_description','cookie_id','convert_fix','sms_convert','check_paid','check_unpaid','check_paid2','fix_address','ardebil_fix','fixdef','post_tracking','gift'
,'with_discount'
    ];
...
//    }
    ...
    {
        return $this->hasMany('App\Models\OrderItem')->where('quantity','>',0)->with('product');
    }
    ...
    {
        return $this->hasMany('App\Models\OrderHistory' , 'order_id','id')->orderBy('created_at','ASC')->where('order_status_id','3');
    }
