...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
{{--		<form method="post" action="{{url('/admin/article-cat/delete')}}">--}}
{{--			{{ csrf_field() }}--}}
			<div class="py-3 px-2">
...
{{--					حذف انتخاب شده ها--}}
{{--				</button>--}}
				<a href="{{url('admin/article-cat/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
			...
			<div class="row w-100 m-0">
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card">
{{--						<h5 class="card-header">      دسته بندی مقالات</h5>--}}
...
{{--									</div>--}}
									<div class="row w-100 m-0">
										<div class="col-sm-12">
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													@foreach($article_cat as $key=> $article)
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('Admin\ArticleController@getEditArticleCat',$article->id)}}"
																type="button"
																class="btn btn-space btn-warning"
																data-toggle="tooltip" title="ویرایش">
																<i class="fa fa-edit"> </i>
															</a>
                                                            <a href="{{URL::action('Admin\ArticleController@getDeleteArticleCat',$article->id)}}"
									...
									<div class="row w-100 m-0">
										...
										<div class="col-sm-12 col-md-7">
											<div class="pagii">
												@if(count($article_cat))
												{!! $article_cat->appends(Request::except('page'))->render()
												!!}
												@endif
											</div>
										</div>
