        ...
        <div class="row">
            <div class="card col-lg-12">
                ...
                <div class="px-2 py-3">
                    ...
                    <a type="button" href="{{URL::action('Admin\ProductController@export')}}"
                    ...
                    <a type="button" href="{{URL::action('Admin\ProductController@getTrash')}}"
                       class="btn-success btn btn-danger">
                    ...
                    <div style="float: right;">
                        <a type="button" class="btn btn-space btn-warning" data-toggle="tooltip" title="ویرایش"> <i
                                class="fa fa-edit "></i> ویرایش </a>
                        <a type="button" class="btn btn-space btn-info" data-toggle="tooltip" title="لیست مشخصات"> <i
                                class="fa fa-clipboard-list"></i> مشخصات</a>
                        <a type="button" class="btn btn-space btn-secondary" data-toggle="tooltip" title="تصاویر بیشتر"><i
                                class="fa fa-images"></i> تصاویر</a>
                        <a type="button" class="btn btn-space btn-dark" data-toggle="tooltip" title="فروش ویژه"><i
                                class="bi bi-shop"></i> فروش ویژه</a>
                        <a type="button" class="btn btn-space btn-success" data-toggle="tooltip"
                           title="اختصاص سوالات متداول"><i class="bi bi-question-circle"></i> سوالات متداول</a>
                        <!--<a type="button" class="btn btn-space btn-twitter" data-toggle="tooltip" title="اختصاص شعار"><i class="bi bi-bookmark"></i> شعارها</a>-->
                        <a type="button" class="btn btn-space btn-instagram" data-toggle="tooltip"
                           title="اختصاص  سایر مشخصات"><i class="bi bi-list-stars"></i> سایر مشخصات</a>
                        <a type="button" class="btn btn-space btn-light" data-toggle="tooltip" title="سفارشات محصول"><i
                                class="bi bi-folder2-open"></i> سفارشات محصول</a>
                        <a target="_blank" type="button" class="btn btn-space btn-primary" data-toggle="tooltip"
                           title="مشاهده در سایت"><i class="fa fa-eye"></i> مشاهده</a>
                        <a type="button" onclick="return confirm('آیا از حذف اطلاعات مطمئن هستید؟');"
                           class="btn btn-space btn-danger" data-toggle="tooltip" title="حذف"><i
                                                ...
                                                <table class="table table-striped table-bordered first dataTable"
                                                    ...
                                                    @foreach($products as $key=> $product)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1 text-center"  dir="ltr">
                                                                @foreach($product->sprcificationstock as $x)
                                                                    <div style="decoration:ltr"></div>

                                                                    <span
                                                                        style="background: orange;color: white; border-radius: 5px;font-size: 10px;margin-left:8px;">
                                                                {{@$x->productSpecificationValue->title}}
                                                               </span>
                                                                <br>
                                                                    <span>
                                                                قیمت اصلی:
                                                                        {{@$x->old_price == 0 ? number_format(@$x->price) :  number_format(@$x->old_price)}}
                                                                        </br>
                                                                @if($product->old_price !== 0)
                                                                            قیمت با تخفیف:
                                                                            {{@$x->old_price == 0 ? 0 :  number_format(@$x->price)}}
                                                                        @endif
                                                               </span>
                                                                @endforeach
                                                                    @if($product->sprcificationstock->count() == 0)
                                                                قیمت اصلی:
                                                                {{@$product->old_price == 0 ? number_format(@$product->price) :  number_format(@$product->old_price)}}
                                                                </br>
                                                                @if($product->old_price !== 0)
                                                                    قیمت با تخفیف:
                                                                    {{@$product->old_price == 0 ? 0 :  number_format(@$product->price)}}
                                                                @endif
                                                                @endif
                                                            </td>
                                                            <td class="sorting_1 text-center">
                                                                {{$product->status  ? 'فعال' : ''}}@if($product->special ==1)
                                                                    /{{$product->special  ? '  پرفروش ترین' : ''}}@endif @if($product->newest ==1)
                                                                    /{{$product->newest  ? '  جدید ترین' : ''}}@endif @if($product->popular ==1)
                                                                    /{{$product->popular  ? '  محبوب ترین' : ''}}@endif
                                                                @if($product->timer ==1)
                                                                    /{{$product->timer  ? '  نمایش ویژه تایمر ' : ''}}@endif
                                                            </td>
                                                            <td class="sorting_1 text-center">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <button type="button"
                                                                            class="btn btn-space btn-success p-1 my-0 ms-0 me-1"
                                                                            data-toggle="modal"
                                                                                        ...
                                                                                        @else
                                                                                            @foreach($product->sprcificationstock as $x)
                                                                                                ...
                                                                                                <input type="hidden"
                                                                                                       ...
                                                                                                       value="{{$product->id}}">
                                                                                                <input type="hidden"
                                                                                                       name="product_specification_value_id[]"
                                                                                                       value="{{$x->product_specification_value_id}}">
                                                                                                <div
                                                                                                    class="row w-100 m-0">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class="">
                                                                                                            <input
                                                                                                                value="{{$x->stocks}}"
                                                                                                                type="text"
                                                                                                                name="count[{{@$x->product_specification_value_id}}]"
                                                                                                                class="form-control"
                                                                                                                id=""
                                                                                                                placeholder="تعداد">
                                                                                                        </div>
                                                                    ...
                                                                    <button type="button"
                                                                            class="btn btn-space btn-info p-1 my-0 ms-0 me-1"
                                                                            data-toggle="modal"
                                                                            data-target="#myModal2{{$product->id}}">
                                                                        ویرایش قیمت
                                                                    </button>
                                                                    ...
                                                                    <div id="myModal2{{$product->id}}" class="modal">
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content border-0">
                                                                                ...
                                                                                <div class="modal-body p-3">
                                                                                    <form
                                                                                        action="{{URL::action('Admin\PriceController@postPrice')}}"
                                                                                        method="POST"
                                                                                        enctype="multipart/form-data"
                                                                                        id="rahweb_form">
                                                                                        {{ csrf_field() }}
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="">
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="text"
                                                                                                            name="old_price"
                                                                                                            class="form-control channels"
                                                                                                            id=""

                                                                                                            value="{{@$product->old_price == 0 ? @$product->price :  @$product->old_price}}"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="">
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            class="form-control channels"
                                                                                                            id=""
                                                                                                            value="{{@$product->old_price == 0 ? 0 :  @$product->price}}"
                                                                                        ...
                                                                                        @else
                                                                                            @foreach($product->sprcificationstock as $x)
                                                                                                <p style="text-align: right">
                                                                                                    {{ @$x->productSpecificationType->title}}
                                                                                                    /{{@$x->productSpecificationValue->title}}
                                                                                                    :
                                                                                                </p>
                                                                                                <input type="hidden"
                                                                                                ...
                                                                                                <input type="hidden"
                                                                                                       name="priceable_type"
                                                                                                       value="App\Models\ProductSpecification">
                                                                                                <div
                                                                                                    class="row w-100 m-0">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class="">
                                                                                                            ...
                                                                                                            <input
                                                                                                                type="text"
                                                                                                                name="old_price[]"
                                                                                                                value="{{@$x->old_price == 0 ? @$x->price :  @$x->old_price}}"
                                                                                                                class="form-control channels"
                                                                                                                id=""
                                                                                                                placeholder="قیمت اصلی">
                                                                                                        </div>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <!--    <a href="{{URL::action('Admin\SloagenController@get',$product->id)}}"-->
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('Admin\ProductFilterController@getIndex',$product->id)}}"
                                                                                               type="button"
                                                                                               target="_blank"
                                                                                               class="btn btn-space btn-dark m-0 w-100"
                                                                                               data-toggle="tooltip"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('Admin\QuizController@product',$product->id)}}"
                                                                                               type="button"
                                                                                               target="_blank"
                                                                                               class="btn btn-space btn-instagram m-0 w-100"
                                                                                               data-toggle="tooltip"
                                                                                               title="اختصاص  تگ برای کوئیز">
                                                                                                <i class="bi bi-tag"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="col p-1">
