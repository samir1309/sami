...
<head>
	...
	<link rel="stylesheet" href="{{asset('assets/site/css/factor.css?V0.23')}}">
...
<body>
	...
	@foreach($orders as $order)
	  @php
        $pay = \App\Models\OrderHistory::where('order_id',$order->id)->where('order_status_id',3)->first();
    @endphp
      <div class="page">
                      ...
                      <div class="bordered grow header-item-data">
                          <table class="grow centered">
                              ...
                              <tr
                                  ...
                                  @if(@$order->gift != null)
                                      <td style="display: flex;align-items: center;justify-content: center;width:20%;">
                                          <img src="{{asset('assets/site/images/gift2.png')}}" width="50" style="background:transparent !important;margin-top:0.5rem;">
                                      </td>
                                  @endif
                              </tr>
          ...
          <table class="content-table tablese">
              ...
              <tr>
                  ...
                  <th class="haft">
                      تخفیف روی محصول (تومان)
                  </th>
                  <th class="shesh">
                      کد تخفیف
                  </th>
                  <th class="haft">
                      تخفیف اعمال شده/مبلغ بعد از تخفیف (تومان)
                  </th>
                  <th class="hasht">
                      مبلغ کل (تومان)
                  </th>
              ...
              @php $discount_with_code = 0 @endphp
                  ...
                  @if($item->quantity > 0)
                      @if($item->created_at > "2021-12-18 09:46:00")
                          <tr>
                              ...
                              <td class="py-2">
                                  @if(@$item->productSpecification->barcode)
                                      <span class="ltr ">
                                        @if(@$item->productSpecification->barcode)
                                              ...
                                              curl_setopt_array($curl, array(
                                                  CURLOPT_URL => 'https://api.products.aspose.app/barcode/generate/generatebarcode',
                                                  ...
                                                  CURLOPT_POSTFIELDS => array('barcodetype' => 'Code128','content' => @$item->productSpecification->barcode,'filetype' => 'PNG','filesize' => '2'),
                                              ));
                                              ...
                                              <img  style="width: 88%;" src="{{'https://products.aspose.app'.$res->downloadPath}}" alt="barcode"   />
                                      ...
                                      <span class="ltr ">
                                        @if(@$item->product->barcode)
                                              ...
                                              curl_setopt_array($curl, array(
                                                  ...
                                                  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                  CURLOPT_CUSTOMREQUEST => 'POST',
                                                  CURLOPT_POSTFIELDS => array('barcodetype' => 'Code128','content' => @$item->product->barcode,'filetype' => 'PNG','filesize' => '2'),
                                              ));
   ...
   {{@$item->discount_code}}
                              ...
                              <td>
                            	...
                            	<span class="ltr">
                                        @php
                                            $m =intval(@$item->price - @$item->discount);
 if(@$m > 0)
                                        $discount_with_code = @$discount_with_code + @$m;
               			...
               			<span class="ltr">
                                    @if($item->discount)
                                {{number_format(@$item->quantity * @$item->discount)}}
                            @else
              ...
              <tr>
                  ...
                  <td>
						<span class="ltr">
						    @if($discount_with_code > 0)
                                جمع تخفیف : {{number_format(@$discount_with_code)}}
                            @else
                                جمع تخفیف : 0
                            @endif
						</span>
