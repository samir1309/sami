...
class Content extends Model
{
    ...
    use SoftDeletes;
    protected $fillable = [
        'title', 'description', 'image', 'lang' , 'keyword', 'content_type','view','status',
        'parent_id', 'description_seo', 'url', 'title_seo','baner_type','link','old_url','webp','image_new','hi','img','convert_hamide','image_convert'
