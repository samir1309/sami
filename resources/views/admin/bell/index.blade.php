...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
                ...
                <div class="row w-100 m-0">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-6 p-1">
                        ...
                        <a href="{{url('/admin/notification')}}"
                           type="button"
                           class="btn w-100 btn-danger btn-info"
                        >
                            همه
                            ({{$all}})
                        </a>
		...
		<form method="post" action="{{URL::action('Admin\BellController@postDelete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-3">
												...
												<table
													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td class="sorting_1">{{@$row->product->title}}
                                                                @if(@$row->specifications->productSpecificationValue)
                                                                    <br>
                                                                    <span
                                                                        style="background: orange;color: white; border-radius: 5px;font-size: 10px;margin-left:8px;">
                                                                 (  {{@$row->specifications->productSpecificationValue->title}} )
                                                               </span>
                                                                    <br>
															...
															<td class="sorting_1">
                                                                ...
                                                                تاریخ در خواست:
                                                                        <br>
                                                                {{jdate('H:i Y/m/d',\Carbon\Carbon::parse(@$row->created_at)->timestamp)}}
                                                                    </span>
                                                            <br>
                                                                @if($row->status == 1)
                                                                    <span class="badge" style=" background-color:#198754">
                                                                        تاریخ ارسال:
                                                                        <br>
                                                                         {{jdate('H:i Y/m/d',\Carbon\Carbon::parse(@$row->updated_at)->timestamp)}}
                                                                </span>
                                                                    @endif
